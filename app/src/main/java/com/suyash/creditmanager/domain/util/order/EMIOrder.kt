...
sealed class EMIOrder(override var orderType: OrderType, override val label: String) : Order {
    ...
    class EMIsRemaining(orderType: OrderType, label: String = "EMIs Remaining") :
        EMIOrder(orderType, label)
